...
public class AuthServiceImpl implements AuthService {
	...
	public void register(RegisterRequest request) {
		...
		AuthUser authUser = AuthUser.builder().email(request.getEmail()).password(generatePassword(6))
	...
	public void activate(ActivateAccountRequest request) {
		...
		if (!request.getTemporaryPassword().trim().equals(user.getPassword().trim())) {
		...
		log.info("Account activated: {}", request.getEmail());
	}
